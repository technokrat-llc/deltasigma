...
pub enum ModulatorType {
    ABCD(Array<usize, ndarray::Ix2>),
    NTF(ZKP),
}

pub fn simulateDSM<D>(
    u: Array<usize, ndarray::Ix2>,
    arg2,
    nlev: Array<usize, ndarray::Ix2>,
    x0=0,
    int store_xn=False,
